// src/components/features/commandes/commandes-view.tsx
'use client'
...
import { Plus, Copy, Eye, AlertTriangle, ShoppingCart } from 'lucide-react'
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-surface-border">
              {commandes.map((cmd: Commande) => (
                <tr key={cmd.id} className={`hover:bg-surface-muted/60 transition-colors ${cmd.en_retard ? 'bg-red-50/40' : ''}`}>
